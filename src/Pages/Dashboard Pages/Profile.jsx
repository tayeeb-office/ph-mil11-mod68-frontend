    ...
    <div>
      ...
      <div>
        <div className=" flex items-center justify-center px-6 py-10">
          <div className="w-[280px] rounded-2xl bg-[#F7EFF0] shadow-2xl px-6 py-8 flex flex-col items-center">
            ...
            <h2 className="mt-4 text-lg font-semibold text-black">
              Full Name : {dbUser?.displayName}
            </h2>
            <p className="text-sm text-black font-semibold">
              Mail Address : {dbUser?.email}
            </p>
            <p className="text-sm text-black font-semibold">
              Blood Group : {dbUser?.bloodGroup}
            </p>

            <button className="mt-5 w-full rounded-lg bg-[#D9252C] hover:bg-[#D9252C] text-white font-semibold py-2.5">
